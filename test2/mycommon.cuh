...
#define MYZERO (MYFLOATTYPE)0.000000001
#define MYINFINITY (MYFLOATTYPE)999999999
#define MYPI (MYFLOATTYPE)3.14159265358979323846264338327950288419716939937510582097494 
#define MYEPSILONBIG (MYFLOATTYPE)0.0001
#define MYEPSILONMEDIUM (MYFLOATTYPE)0.0000001
#define MYEPSILONSMALL (MYFLOATTYPE)0.00000000001
